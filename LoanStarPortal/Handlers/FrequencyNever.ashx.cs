...
{
    /// <summary>
    /// Summary description for Advance
    /// </summary>
    public class FrequencyNever : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            int res = db.ExecuteScalarInt("UpdateFrequency", objUser.id, 6);

            var jsonSerializer = new JavaScriptSerializer();
            String resp = "FrequencyNever";
