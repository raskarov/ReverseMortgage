...
{
    /// <summary>
    /// Summary description for FrequencyEveryOtherDay
    /// </summary>
    public class FrequencyEveryOtherDay : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            int res = db.ExecuteScalarInt("UpdateFrequency", objUser.id, 2);
