...
{
    /// <summary>
    /// Summary description for FrequencyEveryOtherWeek
    /// </summary>
    public class FrequencyEveryOtherWeek : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            int res = db.ExecuteScalarInt("UpdateFrequency", objUser.id, 4);

            var jsonSerializer = new JavaScriptSerializer();
            String resp = "FrequencyEveryday";
