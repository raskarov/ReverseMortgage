<%@ Page Language="C#" AutoEventWireup="true" Inherits="Calendar_NET.calendar" Codebehind="calendar.aspx.cs" %>
...
<head>
	<title>AfterLogic Calendar</title>
	<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	<link type="text/css" rel="stylesheet" href="./calendar/skins/<%=defaultSkin%>/calendar_styles.css" />
	<link type="text/css" rel="stylesheet" href="./skins/<%=defaultSkin%>/styles.css" />
	<script type="text/javascript">
		var DAY = 0, WEEK = 1, MONTH = 2;
		var view = WEEK;
		var isLoaded = false;

		var processing_url = "./calendar/processing.aspx";
	</script>
...
<body onclick="<%=strBodyOnClick%>">
    <form id="form" runat="server">
        <table class="wm_information" id="info_cont">
	<tr>
		<td class="wm_info_message" id="info_message">
			<%=_resMan.GetString("InfoLoading")%>
		</td>
	</tr>
</table>
<span id="allspan">
	<div class="wm_content">
		<textarea style="height:0px; top: -10; left: -10; overflow: hidden; position:absolute; visibility:hidden;" id="ev_inline" ></textarea>
		...
		<BaseWebmail:AccountsList id="Control_AccountsList" runat="server" WebMailMode="ajax"></BaseWebmail:AccountsList>

		<table class="wm_toolbar cal_toolbar" id="toolbar">
			<tr>
				<td style="width: 100%">
								
					<div style="position:relative; left:220px; margin:0px;">
						<div id="tab_3" class="time_tabs_outer" style="right:210px; width:100px;"><div onclick="change(3);"><%=_resMan.GetString("TabMonth")%></div></div>
						<div id="tab_2" class="time_tabs_outer" style="right:300px;  width:100px;"><div onclick="change(2);"><%=_resMan.GetString("TabWeek")%></div></div>
						<div id="tab_1" class="time_tabs_outer_activ" style="right:390px; width:100px;"><div onclick="change(1);"><%=_resMan.GetString("TabDay")%></div></div>
					</div>
					...
					<div class="wm_toolbar_item" id="toolbar_new_event" onmouseover="if(mycache_c.calendars != '') this.className='wm_toolbar_item_over'" 
						...
						<img src="./calendar/skins/<%=defaultSkin%>/menu/new_event.gif" alt="<%=_resMan.GetString("AltNewEvent")%>" title="<%=_resMan.GetString("AltNewEvent")%>"/>
						<span>&nbsp;<%=_resMan.GetString("ToolNewEvent")%></span>
					</div>
					<div  class="wm_toolbar_item" id="toolbar_back" onmouseover="this.className='wm_toolbar_item_over'" 
						...
						<img src="./calendar/skins/<%=defaultSkin%>/menu/back.gif" alt="<%=_resMan.GetString("AltBack")%>" title="<%=_resMan.GetString("AltBack")%>"/>
						<span>&nbsp;<%=_resMan.GetString("ToolBack")%></span>
					</div>
					<div  class="wm_toolbar_item" id="toolbar_today" onmouseover="this.className='wm_toolbar_item_over'" 
						...
						<img src="./calendar/skins/<%=defaultSkin%>/menu/today.gif" alt="<%=_resMan.GetString("AltToday")%>" title="<%=_resMan.GetString("AltToday")%>" />
						<span>&nbsp;<%=_resMan.GetString("ToolToday")%>&nbsp;</span>
					</div>

					<div id="toolbar_interval_switch" style="height:24px; width:180px; left:200px">
...
--%>						
		...
		<div class="main_block" id="main_block">
			...
			<tr>
				...
				<td  class="spacer">&nbsp;</td>
				<td id="right" class="right" style="display:none;">
					<div class="calendar_header" id="calhead1">
						<div class="calendar_header_text"><%=_resMan.GetString("CalendarHeader")%></div>
						<div class="arrow"></div>
					</div>
					...
					<div class="calendar_manager" id="manager_box" style="position:relative">
						<div class="calendar_header" id="calhead2">
							<div class="calendar_header_text"><%=_resMan.GetString("CalendarsManager")%></div>
							<div class="arrow"></div>
						</div>
						<div id='manager_list' style='height: 20px; position: relative; overflow: auto; overflow-x: hidden; overflow-y: auto; width: 200px;'>
							<div class="new_calendar"><a href="javascript:void(0);"  onclick="manager_form_create();"><span>+</span>&nbsp;<%=_resMan.GetString("CalendarActionNew")%></a></div>
						</div>
					...
					<div class="eventcontainer_2" id="eventcontainer" style="position:relative;">
						...
						<div class="event_middle" style="">
							<div class="event_text" style="">
								<div class="time" id="ef_fulldate"><%=_resMan.GetString("EventHeaderNew")%></div>
								<div class="text">
									<div class="em_spacer"></div>
									<form onsubmit="">
										<div class="row_title"><%=_resMan.GetString("EventSubject")%></div>
										<div><input id="EventSubject" class="input" name="EventSubject" style="width:338px;" maxlength="50" tabIndex="1" /></div>
										<div class="em_spacer"></div>
										<div class="row_title"><%=_resMan.GetString("EventCalendar")%></div>
										...
										<table border="0" cellpadding="0" cellspacing="0" style="float:left;margin-top:0.6em" >
											<tr>
												<td id="tmp_id" class="row_title"><%=_resMan.GetString("EventFrom")%></td>
												<td>
										...
										<table border="0" cellpadding="0" cellspacing="0" style="float:left;margin-top:0.6em">
											<tr>
												<td class="row_title" style="text-align:center; float:none"><%=_resMan.GetString("EventTill")%></td>
												<td>
										...
										<div class="em_spacer"></div>
										<div class="row_title"><%=_resMan.GetString("CalendarDescription")%></div>
										...
										<input type="button" style="display:inline; margin:0.6em 10px 0px 0px;" id="button_save" value="<%=_resMan.GetString("ButtonSave")%>" class="wm_button" onclick=" evform_submit();" tabIndex="7" />&nbsp;&nbsp;&nbsp;&nbsp;
										<input type="button" style="display:inline; margin:0.6em 10px 0px 0px;" value="<%=_resMan.GetString("ButtonCancel")%>" class="wm_button" onclick="$('edit_window').style.display='none'; evform_cancel();" tabIndex="8" />&nbsp;&nbsp;&nbsp;&nbsp;
										<input type="button" style="display:inline; margin:0.6em 10px 0px 0px;" name="delbut" id="delbut" value="<%=_resMan.GetString("ButtonDelete")%>" class="wm_button" onclick="evform_delete();" tabIndex="9" />
										<div class="em_spacer"></div>
									</form>
									<br>
								</div>
		...
		</div><!--#edit_window--><div id="manager_window">
			<div class="mask"></div>
			<!-- manager form -->
						...
						<div class="event_edit">
							...
							<div class="event_middle">
								<div class="event_text">
									<div class="time" style="text-indent:92px;" id="ef_fulldate_calendar"><%=_resMan.GetString("CalendarHeaderNew")%></div>
									<div class="text">
										<div class="em_spacer"></div>
										<div class="row_title" style="width:8em"><%=_resMan.GetString("CalendarName")%></div>
										...
										<div class="em_spacer"></div>
										<div class="row_title" style="width:8em"><%=_resMan.GetString("CalendarDescription")%></div>
										...
										<div class="em_spacer"></div>
										<div class="row_title" style="width:8em"><%=_resMan.GetString("CalendarColor")%></div>
										...
										<input type="button" id="button_save" value="<%=_resMan.GetString("ButtonSave")%>" class="wm_button" style="display:inline; margin:0.6em 10px 0px 0px;" onclick="manager_form_save(this);" tabIndex="3" />&nbsp;&nbsp;&nbsp;&nbsp;
										<input type="button" value="<%=_resMan.GetString("ButtonCancel")%>" class="wm_button" style="display:inline; margin:0.6em 10px 0px 0px;" onclick="manager_form_cancel();" tabIndex="4" />&nbsp;&nbsp;&nbsp;&nbsp;
										<input type="button" name="delbut" id="delbut_calendar" value="<%=_resMan.GetString("ButtonDelete")%>" class="wm_button" style="display:inline; margin:0.6em 10px 0px 0px;" onclick="manager_form_delete($('clndform_id').value);" tabIndex="5" />
										<div class="em_spacer"></div>
									</div>
								</div>
							</div>
