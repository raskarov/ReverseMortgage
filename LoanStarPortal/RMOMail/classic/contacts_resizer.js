...
CContactsList.prototype =
{
	ResizeBody: function(mode)
	{
	    if (!Browser.IE || Browser.Version >= 7)
	    {
            ...
            this.ResizeContactsTable(this._leftDiv.offsetWidth);
	...
	{
		var res = 0;
		var offsetHeight = this._logo.offsetHeight;    if (offsetHeight) { res += offsetHeight; } else { return this._externalHeight; }
