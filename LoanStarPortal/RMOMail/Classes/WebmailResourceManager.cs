...
namespace WebMailPro
{
	...
	/// <summary>
	/// Summary description for WebmailResourceManager.
	/// </summary>
	public class WebmailResourceManagerCreator : Control
	{
		...
		public WebmailResourceManager CreateResourceManager(string lang)
		{
			...
			WebmailResourceManager newManager = null;
			string culture = "";
			...
			newManager = new WebmailResourceManager(Path.Combine(Utils.GetDataFolderPath(), @"langs"));
