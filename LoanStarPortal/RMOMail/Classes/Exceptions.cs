...
namespace WebMailPro
{
	public class WebMailException : ApplicationException
	{
		...
		public WebMailException(string message, Exception inner) : base(message, inner) {}

		public WebMailException(Exception inner) : base((inner != null) ? inner.Message : (new WebmailResourceManagerCreator()).CreateResourceManager().GetString("WebMailException"), inner) {}
	}
