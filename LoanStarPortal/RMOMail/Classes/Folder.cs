...
namespace WebMailPro
{
	...
	public class Folder : IComparable
	{
		...
		//public const long DefaultIDFolder = -1;
		//public const int DefaultIDAccount = -1;
		//public const long DefaultIDParent = 0;
		//public const FolderType DefaultType = FolderType.Inbox;
		//public const string DefaultName = Constants.FolderNames.Inbox;
		//public const string DefaultFullPath = "";
		...
		//public const short DefaultFolderOrder = 0;
		//public const MailBee.ImapMail.Folder DefaultImapFolder = null;
		...
		public int CompareTo(object obj)
		{
			...
			if (this._fld_order < fobj._fld_order) return -1;
			if (this._fld_order == fobj._fld_order) return 0;
			if (this._fld_order > fobj._fld_order) return 1;
