...
CCalendarScreen.prototype = {
	...
	ResizeBody: function(mode)
	{
		...
		this._ifrCalendar.style.width = "100%"; //GetWidth() + 'px';
		this._ifrCalendar.style.height = "100%";//GetHeight() + 'px';
	},
	...
	Create: function ()
	{
		...
		this._ifrCalendar.id = "ifCalendar";
		var obj = this;
		this._ifrCalendar.onresize = function() {
			obj._ifrCalendar.style.width = '100%'; //  (GetWidth() + 1) + 'px';
			obj._ifrCalendar.style.height = '100%';
		};
		this.Hide();
	},
