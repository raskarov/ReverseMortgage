...
},RaiseValueChangedEvent:function(_e,_f){
var _10=this.ValueChangedEventArgs(_e,_f);
var _11=_10.NewDate;
var _12=_10.OldDate;
if((!_11&&!_12)||(_11&&_12&&_11.toString()==_12.toString())){
return false;
}
this.InitialValue=this.GetValue();
var _13=this.RaiseEvent("OnValueChanged",_10);
if(this.AutoPostBack&&_13){
this.RaisePostBackEvent();
}
return _13;
},HandleWheel:function(_14){
var _15=(_14)?-this.Step:this.Step;
return this.Move(_15,false);
},Move:function(_16,_17){
if(this.IsReadOnly()){
return false;
}
var _18=this.ParseDate(this.TextBoxElement.value);
if(!_18){
return false;
}
var _19=this.GetRaplacedFormat(_18);
var _1a=this.GetCurrentDatePart(_19);
switch(_1a){
case "y":
_18.setFullYear(_18.getFullYear()+_16);
break;
case "M":
_18.setMonth(_18.getMonth()+_16);
break;
case "d":
_18.setDate(_18.getDate()+_16);
break;
case "h":
_18.setHours(_18.getHours()+_16);
break;
case "H":
_18.setHours(_18.getHours()+_16);
break;
case "m":
_18.setMinutes(_18.getMinutes()+_16);
break;
case "s":
_18.setSeconds(_18.getSeconds()+_16);
break;
default:
break;
}
if((this.GetMaxDate()<_18)||(this.GetMinDate()>_18)){
return false;
}
if(!_17){
this._SetValue(this.DateFormatInfo.FormatDate(_18,this.DateFormat));
}else{
this.SetValue(this.DateFormatInfo.FormatDate(_18,this.DateFormat));
}
var _1b=this.GetRaplacedFormat(_18);
this.SetCaretPosition(_1b.indexOf(_1a));
return true;
},GetRaplacedFormat:function(_1c){
var _1d=this.DateFormat;
var _1e=new Array({"part":"y","value":_1c.getYear()},{"part":"M","value":_1c.getMonth()+1},{"part":"d","value":_1c.getDate()},{"part":"h","value":_1c.getHours()},{"part":"H","value":_1c.getHours()},{"part":"m","value":_1c.getMinutes()},{"part":"s","value":_1c.getSeconds()});
var i;
for(i=0;i<_1e.length;i++){
var p=_1e[i].part;
var _21=new RegExp(p,"g");
var _22=new RegExp(p);
var _23=new RegExp(p+p);
var _24=p+p;
if(_1d.match(_22)&&!_1d.match(_23)&&_1e[i].value.toString().length>1){
_1d=_1d.replace(_21,_24);
}
}
if(_1d.match(/MMMM/)){
var _25=this.DateTimeFormatInfo.MonthNames[this.GetDate().getMonth()];
var i;
var _24="";
for(i=0;i<_25.length;i++){
_24+="M";
}
_1d=_1d.replace(/MMMM/,_24);
}
if(_1d.match(/dddd/)){
...
_1d=_1d.replace(/dddd/,_24);
}
return _1d;
},GetCurrentDatePart:function(_27){
var _28="";
var _29="yhMdhHms";
while(((_29.indexOf(_28)==(-1))||_28=="")){
this.CalculateSelection();
_28=_27.substring(this.SelectionStart,this.SelectionStart+1);
this.SelectText(this.SelectionStart-1,this.SelectionEnd-1);
}
return _28;
},ValueChangedEventArgs:function(_2a,_2b){
return {"NewValue":_2a,"OldValue":_2b,"NewDate":this.ParseDate(_2a),"OldDate":this.ParseDate(_2b)};
},ParseDate:function(_2c,_2d){
try{
var _2e=new Telerik.DateParsing.DateTimeLexer(this.DateFormatInfo);
var _2f=_2e.GetTokens(_2c);
var _30=new Telerik.DateParsing.DateTimeParser(this.DateTimeFormatInfo.TimeInputOnly);
var _31=_30.Parse(_2f);
_2d=this.GetParsingBaseDate(_2d);
var _32=_31.Evaluate(_2d,this.DateFormatInfo);
return _32;
}
catch(parseError){
...
},GetParsingBaseDate:function(_33){
var _34=_33;
if(_34==null){
_34=new Date();
}
if(!this.DateInRange(_34)){
_34=this.GetMinDate();
}
_34.setHours(0,0,0,0);
return _34;
},GetFormattedValue:function(_35,_36){
if(_35!=""){
var _37=this.ParseDate(_35);
_37=(_37>this.GetMaxDate())?this.GetMaxDate():_37;
_37=(_37<this.GetMinDate())?this.GetMinDate():_37;
_35=this.DateFormatInfo.FormatDate(_37,_36);
}
return _35;
},GetMaxDate:function(){
return this.MaxDate;
...
return this.MinDate;
},SetDate:function(_38){
this.SetValue(this.DateFormatInfo.FormatDate(_38,this.DateFormat));
},GetDate:function(_39){
var _3a=this.CloneDate(this.HiddenElement.value);
return _3a;
},SetMaxDate:function(_3b){
return this.MaxDate;
},SetMinDate:function(_3c){
this.MinDate=_3c;
},CloneDate:function(_3d){
if(!_3d){
return null;
}
...
return _3e;
},SetHiddenValue:function(_3f){
this.HoldsValidDateValue=true;
var _40="";
if(_3f!=""){
var _41=this.ParseDate(_3f);
if(_41==null){
var _42={Reason:RadInputErrorReason.ParseError,InputText:_3f};
_41=this.ResolveDateError(_42,null);
}
if(_41==null&&!this.ErrorHandlingCanceled){
return this.Invalidate();
}
if(!this.DateInRange(_41)){
var _42={Reason:RadInputErrorReason.OutOfRange,InputText:_3f};
_41=this.ResolveDateError(_42,_41);
}
if(!this.DateInRange(_41)&&!this.ErrorHandlingCanceled){
return this.Invalidate();
}
_40=this.DateFormatInfo.FormatDate(_41,this.hiddenFormat);
}
return this.CallBase("SetHiddenValue",[_40]);
},Invalidate:function(){
this.HoldsValidDateValue=false;
this.CallBase("ClearHiddenValue",[]);
return false;
},ResolveDateError:function(_43,_44){
var _45=this.GetDate();
this.RaiseErrorEvent(_43);
var _46=this.GetDate();
if(_46-_45!=0){
return _46;
}else{
return _44;
}
},DateInRange:function(_47){
return (this.CompareDates(_47,this.GetMinDate())>=0)&&(this.CompareDates(_47,this.GetMaxDate())<=0);
},CompareDates:function(_48,_49){
return _48-_49;
},GetDisplayValue:function(){
var _4a=this.CloneDate(this.HiddenElement.value);
return this.DateFormatInfo.FormatDate(_4a,this.DisplayDateFormat);
},GetEditValue:function(){
var _4b=this.CloneDate(this.HiddenElement.value);
return this.DateFormatInfo.FormatDate(_4b,this.DateFormat);
