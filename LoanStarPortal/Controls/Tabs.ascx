...
<radTS:RadMultiPage id="RadMultiPage1" runat="server" Height="96%" RenderSelectedPageOnly="true">
    <radTS:PageView id="PageviewInfo" runat="server"></radTS:PageView>
    <radTS:PageView id="PageviewCalculator" runat="server"></radTS:PageView>
    <radTS:PageView id="PageviewCheckLists" runat="server"></radTS:PageView>
    <radTS:PageView id="PageviewConditions" runat="server"></radTS:PageView>
</radTS:RadMultiPage>
