<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Trustee.ascx.cs" Inherits="LoanStarPortal.Controls.Trustee" %>
 ...
 >
    <columns>
        <asp:TemplateField HeaderText="Signature Line" HeaderStyle-Width="90%">
            <ItemTemplate>
                <asp:Label runat="server" ID="lblName" EnableViewState="false" Text='<%#Eval("SignatureLine")%>'></asp:Label>
