...
<table border="0" width="100%" cellpadding="0" cellspacing="0">
    <tr id="gridtr" runat="server" visible="false">    
        <td>
            <radG:RadGrid ID="gVendors" Skin="WebBlue" runat="server" CssClass="RadGrid" GridLines="None" AllowPaging="True" PageSize="20" AllowSorting="true" Width="99%" AutoGenerateColumns="False" EnableAJAX="False" ShowStatusBar="false" HorizontalAlign="NotSet" OnItemCommand="gVendors_ItemCommand" OnSortCommand="gVendors_SortCommand" OnPageIndexChanged="gVendors_PageIndexChanged">
            <MasterTableView CommandItemDisplay="None" GridLines="None" DataKeyNames="ID">
                <Columns>
            ...
            <radTS:RadMultiPage id="RadMultiPage1" runat="server" SelectedIndex="0" Height="85%" EnableViewState="False">
                ...
                <radTS:PageView ID="pvAffiliation" runat="server" EnableViewState="False">
                    <table border="0" cellpadding="0" cellspacing="0" style="width:100%;padding-top:10px">
                        ...
                        <tr>
                            <td class="vendorbasicinfolbl"><asp:Label ID="Label17" runat="server" Text="Affiliation:"></asp:Label></td>
                            <td class="vendorbasicinfoctl"><asp:DropDownList ID="ddlAffiliation" runat="server" Width="120px"></asp:DropDownList></td>
                            <td>&nbsp;</td>
                        </tr>
                        <tr id="trAffiliation" runat="server">
                            <td class="vendorbasicinfolbl"><asp:Label ID="Label21" runat="server" Text="Description:"></asp:Label></td>
                            <td class="vendorbasicinfoctl"><asp:TextBox ID="tbAffiliation" runat="server" MaxLength="256" Width="350px"></asp:TextBox>&nbsp;<asp:CustomValidator
                        ...
                        <tr>
                            <td>&nbsp;</td>
                            <td><asp:Button ID="btnSaveAffiliation" runat="server" Text="Save" OnClick="btnSaveAffiliation_Click" CausesValidation="true" /></td>
                            <td>&nbsp;</td>
                        </tr>                        
                    </table>
                </radTS:PageView>
    ...
    <tr runat="server" id="buttontr" style="padding-top:10px;padding-left:10px;"><td><asp:Button ID="btnBack" runat="server" Text="Close" OnClick="btnBack_Click" CausesValidation="false" /></td></tr>
</table>
</div>
