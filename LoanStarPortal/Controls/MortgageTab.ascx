<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MortgageTab.ascx.cs" Inherits="LoanStarPortal.Controls.MortgageTab" %>
...
<radspl:RadSplitter ID="RadSplitter2" runat="server" Height="95%" Orientation="Horizontal" Width="100%" BorderWidth="0" BorderStyle="None" BorderSize="0" Skin="Default" LiveResize="false">
   ...
   <div RadResizeStopLookup="true" RadShowStopLookup="true" >
    ...
    <table border="0" cellspacing="0" cellpadding="0" style="width:100%;vertical-align:top;">
        <tr>
            <td class="title" nowrap width="20%"><asp:Label ID="lblMortgageName" runat="server"></asp:Label>&nbsp;</td>
            <td class="title" nowrap width="35%"><asp:Label ID="lblCity" runat="server"></asp:Label><asp:Label ID="lblCounty" runat="server"></asp:Label><asp:Label ID="lblState" runat="server"></asp:Label>&nbsp;</td>
            <td class="title" nowrap width="20%"><asp:Label ID="lblProduct" runat="server"></asp:Label>&nbsp;</td>
            <td class="title" align="right" width="25%"><asp:Label ID="lblProfileStatus" runat="server"></asp:Label>&nbsp;&nbsp;</td>
            <td align="right">&nbsp;</td>
        </tr>
    </table>
    </div>
