                ...
                <table cellpadding="0" cellspacing="0" style="width:100%">
                    ...
                    <td valign="top" width="100%" bordercolorlight="#000000">
                        <div id="accordion">
	                        <h3>Today</h3>
	                        <div>
                                <radG:RadGrid ID="gridConditions1" Skin="Default" runat="server" AutoGenerateColumns="False" EnableAJAX="False" GridLines="Vertical" 
                                    AllowPaging="True" PageSize="30" Width="99%"
                                    OnNeedDataSource="gridConditions1_NeedDataSource" 
                                    OnItemCommand="gridConditions1_ItemCommand" 
                                    OnItemDataBound="gridConditions_ItemDataBound" 
                                    OnPreRender="gridConditions1_PreRender"
	                        ...
	                        <h3>Other</h3>
	                        <div>
                                <radG:RadGrid ID="gridConditions2" Skin="Default" runat="server" AutoGenerateColumns="False" EnableAJAX="False" GridLines="Vertical" 
                                    AllowPaging="True" PageSize="30" Width="99%"
                                    OnNeedDataSource="gridConditions2_NeedDataSource" 
                                    OnItemCommand="gridConditions2_ItemCommand" 
                                    OnItemDataBound="gridConditions_ItemDataBound" 
                                    OnPreRender="gridConditions2_PreRender" 
                                    OnPageIndexChanged="gridConditions_PageIndexChanged">
                                    <MasterTableView DataKeyNames="ID">
                                        <NoRecordsTemplate>No items</NoRecordsTemplate>
                                        <ExpandCollapseColumn Visible="False">
	                        ...
	                        <h3>Completed</h3>
	                        <div>
                                <radG:RadGrid ID="gridConditions3" Skin="Default" runat="server" AutoGenerateColumns="False" EnableAJAX="False" GridLines="Vertical" 
                                    AllowPaging="True" PageSize="30" Width="99%"
                                    OnNeedDataSource="gridConditions3_NeedDataSource" 
                                    OnItemCommand="gridConditions3_ItemCommand" 
                                    OnItemDataBound="gridConditions_ItemDataBound" 
                                    OnPreRender="gridConditions3_PreRender" 
                                    OnPageIndexChanged="gridConditions_PageIndexChanged">
                                    <MasterTableView DataKeyNames="ID">
                                        <NoRecordsTemplate>No items</NoRecordsTemplate>
                                        <ExpandCollapseColumn Visible="False">
                        ...
                        <br /><br /> 
                        &nbsp;<asp:LinkButton ID="btnAddCondition" runat="server" Text="Add Condition/Task" CssClass="AddCondition" OnClientClick="ShowDialog()" OnClick="btnAddCondition_Click"></asp:LinkButton>
                    </td>
                </tr>
            </table>
            </asp:Panel>
