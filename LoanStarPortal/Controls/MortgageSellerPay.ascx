<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MortgageSellerPay.ascx.cs" Inherits="LoanStarPortal.Controls.MortgageSellerPay" %>
<br>
SellerPay
 ...
 >
    <columns>
        ...
        <asp:TemplateField HeaderText="Amount" HeaderStyle-Width="20%">
            <ItemTemplate>
                <asp:Label runat="server" ID="lblAmount" EnableViewState="false" Text='<%#string.Format("{0:C}", Eval("SellerPortion"))%>'></asp:Label>
            </ItemTemplate>
            <FooterTemplate>
