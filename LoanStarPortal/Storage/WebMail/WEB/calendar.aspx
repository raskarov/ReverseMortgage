			...
			<tr>
				<td>
					<div style="position:relative; margin:0px;">
						<div id="tab_3" class="time_tabs_outer" style="right:210px;"><div onclick="change(3);"><%=_resMan.GetString("TabMonth")%></div></div>
						<div id="tab_2" class="time_tabs_outer" style="right:346px;"><div onclick="change(2);"><%=_resMan.GetString("TabWeek")%></div></div>
						<div id="tab_1" class="time_tabs_outer_activ" style="right:482px;"><div onclick="change(1);"><%=_resMan.GetString("TabDay")%></div></div>
					</div>
